    ...
    public class AddressBookRL : IAddressBookRL
    {
        ...
        public Addresses SaveAddressBookRL(AddressEntity addressEntity)
        {
            try
            {
                ...
                _cache.Remove($"Addresses_{addressEntity.UserEmail}");
        ...
        public bool DeleteAddressBookRL(string? email, int id)
        {
            ...
            _cache.Remove($"Address_{id}");  // Remove the individual address cache
        ...
        private static Addresses MapToDTO(AddressEntity entity)
        {
        ...
        private async Task RefreshAllAddressesCache()
        {
